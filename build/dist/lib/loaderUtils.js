...
exports.getAntDefaultLessPath = exports.getScssThemePath = undefined;
...
const getAntDefaultLessPath = exports.getAntDefaultLessPath = options => {
  // eslint-disable-next-line max-len
  const antDefaultLessPath = options.antDefaultLessPath || _index2.default.ANT_DEFAULT_LESS_PATH;

  if (!antDefaultLessPath) {
    throw new Error('Path to an LESS default theme file must be specified through the scssThemePath loader option, ' + 'or passed to the plugin\'s constructor.');
  }
